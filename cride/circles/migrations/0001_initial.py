# Generated by Django 2.2.2 on 2020-08-22 15:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, help_text='the datetime the object was created', verbose_name='created at')),
                ('modified', models.DateTimeField(auto_now=True, help_text='the datetime the object was modified', verbose_name='modified at')),
                ...
                ('picture', models.FileField(blank=True, null=True, upload_to='circles/pictures')),
                ('rides_offered', models.PositiveIntegerField(default=0)),
                ('rides_taken', models.PositiveIntegerField(default=0)),
                ('verified', models.BooleanField(default=False, help_text='Verified circles are also know as official commnunities.', verbose_name='verified circle')),
